...
\hypersetup{
  ...
  pdfauthor={BlackHoleSimulator Project},
...
\author{BlackHoleSimulator Project\\[2pt]
\small\ttfamily https://github.com/AaronShawn/blackhole-simulator}
\date{2026 年 9 月}
...
12 组有效测点残差 RMS 为 $2.37\%$；并对单点耗时在软光栅机器上出现的 $2\times$ 量化台阶
...
explain a $2\times$ quantisation step observed on soft-rasterised hardware. All figures,
...
\input{parts/02_theory}
\input{parts/03_numerics}
\input{parts/04_impl}
\input{parts/05_verify}
\input{parts/06_results}
\input{parts/07_discussion}
\input{parts/08_conclusion}
\input{parts/10_bib}
\appendix
\input{parts/09_appendix}
